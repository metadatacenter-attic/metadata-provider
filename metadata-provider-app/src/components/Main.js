    ...
    <>
      ...
      <div className="App-content">
        ...
        <div className="instructions-container">
          <p><span className="database">Database: NCBI BioSample </span><span>(4,346 samples from Homo sapiens)</span>
          </p>
          ...
          {queryIndex &&
          <div className="goal">
            <p variant={"info"}><i dangerouslySetInnerHTML={{__html: sampleQueries[queryIndex].researchQuestion}}/>
            </p>
          </div>}
        </div>
